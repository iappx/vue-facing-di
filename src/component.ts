...
import { type ComponentCustomOptions, defineComponent } from 'vue'
import { getProviderFunction, getSuperSlot, obtainSlot } from 'vue-facing-decorator/src/utils'
import { build as optionSetup } from 'vue-facing-decorator/src/option/setup'
import { build as optionComputed } from 'vue-facing-decorator/src/option/computed'
import { build as optionData } from './data'
import { build as optionMethodsAndHooks } from 'vue-facing-decorator/src/option/methodsAndHooks'
import { build as optionRef } from 'vue-facing-decorator/src/option/ref'
import { build as optionWatch } from 'vue-facing-decorator/src/option/watch'
import { build as optionProps } from 'vue-facing-decorator/src/option/props'
import { build as optionInject } from 'vue-facing-decorator/src/option/inject'
import { build as optionEmit } from 'vue-facing-decorator/src/option/emit'
import { build as optionVModel } from 'vue-facing-decorator/src/option/vmodel'
import { build as optionAccessor } from 'vue-facing-decorator/src/option/accessor'
import { build as optionProvide } from 'vue-facing-decorator/src/option/provide'
import type { OptionBuilder } from 'vue-facing-decorator/src/optionBuilder'
import * as DecoratorCompatible from 'vue-facing-decorator/src/deco3/utils'
...
function _Component(cb: (cons: Cons, option: ComponentOption) => any, arg: ComponentConsOption, ctx?: any) {
...
export function DiComponentBase(arg: ComponentConsOption, ctx?: any): any {
...
export const Component = DiComponentBase